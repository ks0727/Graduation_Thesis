    ...
    with open(txt_file_path,'w') as ft:
        ...
        for a in range(9):
            for b in range(9):
                for c in range(9):
                    total+=1
                    make_input = Make_input(text=words[i],font_size=50,text_color=(min(32*a,255),min(32*b,255),min(32*c,255)))
                    ...
                    result_dict[words[i]][(min(32*a,255),min(32*b,255),min(32*c,255))] = succeed
